      ...
      <div class="section--about--inner">
        ...
        <div class="inner--main">
          ...
          <div class="main--right-side">
            <b>Мы понимаем, что в современном быстро меняющемся мире, правовые вопросы могут стать серьезным препятствием для развития вашего бизнеса.</b>
            <p>Поэтому наша задача – помочь вам минимизировать риски и достичь успеха, предлагая комплексный набор юридических услуг, адаптированных под ваши потребности.</p>
            <a v-scroll-to.scrollTo="{ el: '#contact' }" class="btn">
              <div class="btn--arrow">
...
export default {
  name: "SectionAbout",
    ...
    data() {
    return {
      vector: "../public/img/sectionAbout/Vector.svg"
    };
  }
}
</script>
